...
Shader "Water/WaterShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float clampResult234 = clamp( ( ( ( 1.0 - clampResult168 ) * _SeaFoamIntensity ) - tex2D( _SeaFoamMask, panner235 ).r ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=14101
7;29;1906;1004;1296.964;1011.032;1;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;221;-544.4675,-208.0668;Float;False;2;2;0;FLOAT;0,0,0,0;False;1;COLOR;0.0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=9A24BB2937DB68FC246841C02F08B228CA58F932