...
Shader "Water/WaterShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_131_0 = ( clampResult163 + _HeightColorStrength );
			float clampResult160 = clamp( (0.0 + (temp_output_131_0 - 0.5) * (0.8 - 0.0) / (1.0 - 0.5)) , 0.0 , 1.0 );
			float4 lerpResult133 = lerp( lerpResult171 , ( lerpResult11 * temp_output_131_0 ) , clampResult160);
...
/*ASEBEGIN
Version=14101
7;29;1906;1004;3171.65;617.4669;2.537158;True;True
Node;AmplifyShaderEditor.SamplerNode;147;-2140.139,322.0198;Float;True;Property;_InputHeight;InputHeight;1;0;Create;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ClampOpNode;163;-1433.372,103.6928;Float;False;3;0;FLOAT;0,0,0,0;False;1;FLOAT;0,0,0,0;False;2;FLOAT;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;131;-1181.048,56.86792;Float;False;2;2;0;FLOAT;0,0,0,0;False;1;FLOAT;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;211;-448.3913,844.2792;Float;False;Constant;_Test;Test;39;0;Create;-0.5;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;155;-477.7229,62.78345;Float;False;5;0;FLOAT;0,0,0,0;False;1;FLOAT;0,0,0,0;False;2;FLOAT;1,0,0,0;False;3;FLOAT;0,0,0,0;False;4;FLOAT;1,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;210;60.41437,497.1101;Float;False;2;2;0;FLOAT;0.0;False;1;FLOAT;0.0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;205;61.27668,621.6483;Float;False;Constant;_Vector2;Vector 2;38;0;Create;0,0,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;207;0.4248629,892.0387;Float;False;Property;_HeightCoeff;HeightCoeff;38;0;Create;1;0;1000;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;127;-387.7889,-200.1226;Float;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ClampOpNode;160;-272.1228,287.2042;Float;False;3;0;FLOAT;0,0,0,0;False;1;FLOAT;0,0,0,0;False;2;FLOAT;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;206;323.8707,460.329;Float;False;3;3;0;FLOAT;0.0;False;1;FLOAT3;0;False;2;FLOAT;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=9164028C8DA0C54E94E64F0528853DCBFA701714